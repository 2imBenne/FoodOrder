...
router.patch("/:id/cancel", (0, authMiddleware_1.authenticate)(), (0, validateRequest_1.validateParams)(orderIdParam), (0, validateRequest_1.validateBody)(cancelSchema), orderController_1.cancelOrder);
